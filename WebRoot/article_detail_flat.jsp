<%@ page import="com.cdut.bbs.*,java.sql.*,java.util.*"%>
...
%>
Input format Error.Please input again.
<%
//		e.printStackTrace();
		return;
	} 
				...
				<tbody>
					<tr>
						...
						<td class="jive-icon-label"><a id="jive-reply-thread"
							href="reply.jsp?id=<%= id%>&rootid=<%=id %>">回复本主题</a>
						</td>
					</tr>
				</tbody>
			</table>
...
//  	String ptrStr = "";
										...
										for(Iterator<Article> it = articles.iterator() ; it.hasNext() ; ){
											Article b = it.next();
											String floor = floorNum==1 ? "楼主" : floorNum + "楼";
  										%>
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="jive-icon-label"><a
																							href="reply.jsp?id=<%=b.getId() %>&rootId=<%=b.getRootId() %>"
																							title="回复本主题">回复</a></td>
																					</tr>
																				</tbody>
																			</table>
