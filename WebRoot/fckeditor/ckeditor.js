...
(function() {
		...
		return {
			...
			on : function(b, d, g, k, h) {
				...
				if (0 > f.getListenerIndex(d)) {
					f = f.listeners;g || (g = this);isNaN(h) && (h = 10);
					var B = this;
					p.fn = d;
					p.priority = h;
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			transformPlainTextToHtml : function(a, f) {
				...
				c = c.replace(/\n/g, "\x3cbr\x3e");b || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function(a) {
			...
			setTimeout : function(a, f, b, c, h) {
				h || (h = window);b || (b = h);return h.setTimeout(function() {
			...
			createClass : function(a) {
				...
				});h && this.extend(f.prototype, h, !0);a && this.extend(f, a, !0);return f
			},
			...
			convertToPx : function() {
				var a;
				return function(f) {
					a || (a = CKEDITOR.dom.element.createFromHtml('\x3cdiv style\x3d"position:absolute;left:-9999px;top:-9999px;margin:0px;padding:0px;border:0px;"\x3e\x3c/div\x3e', CKEDITOR.document), CKEDITOR.document.getBody().append(a));return /%$/.test(f) ? f : (a.setStyle("width", f), a.$.clientWidth)
				}
			}(),
			repeat : function(a, f) {
			...
			normalizeHex : function(a) {
				return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, h) {
					a = b.toLowerCase();3 == a.length && (a = a.split(""), a = [ a[0], a[0], a[1], a[1], a[2], a[2] ].join(""));return "#" + a + h
				})
			},
			...
			keystrokeToString : function(a, b) {
				var c = b & 16711680,
					...
					p = [],
					m = [];
				c & CKEDITOR.CTRL && (p.push(d ? "⌘" : a[17]), m.push(d ? a[224] : a[17]));c & CKEDITOR.ALT && (p.push(d ? "⌥" : a[18]), m.push(a[18]));c & CKEDITOR.SHIFT && (p.push(d ? "⇧" : a[16]), m.push(a[16]));h && (a[h] ? (p.push(a[h]), m.push(a[h])) : (p.push(String.fromCharCode(h)), m.push(String.fromCharCode(h))));return {
					display : p.join("+"),
					aria : m.join("+")
				}
			},
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
		...
		clone : function(a, d) {
			...
			b(e);
			e = new CKEDITOR.dom.node(e);CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (this.type == CKEDITOR.NODE_ELEMENT || this.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) && c(e);return e
		},
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
				...
				function a(b, c, f) {
					if (c && c.type == CKEDITOR.NODE_ELEMENT) {
						...
						if (b.isIdentical(c)) {
							...
							c.moveChildren(b, !f);c.remove();h && h.type == CKEDITOR.NODE_ELEMENT && h.mergeSiblings()
						}
					}
				}
				return function(b) {
			...
			removeStyle : function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");else {
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (f)
							for (var u = 0; u < f.length; u++) b.push([ a, c[d], f[u] ].join("-"));
			...
			getDocumentPosition : function(a) {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var e = this.$.getBoundingClientRect(),
						...
						k = !0;
					CKEDITOR.env.ie && (k = f.getDocumentElement().contains(this), f = f.getBody().contains(this), k = u && f || !u && k);k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = u ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - x, c = e.top + c - m)
				} else
					for (m = this, x = null; m && "body" != m.getName() &&
						"html" != m.getName();) {
						b += m.$.offsetLeft - m.$.scrollLeft;
						c += m.$.offsetTop - m.$.scrollTop;m.equals(this) || (b += m.$.clientLeft || 0, c += m.$.clientTop || 0);
						for (; x && !x.equals(m);) b -= x.$.scrollLeft, c -= x.$.scrollTop, x = x.getParent();
						x = m;
						m = (e = m.$.offsetParent) ? new CKEDITOR.dom.element(e) : null
				}
				a && (e = this.getWindow(), m = a.getWindow(), !e.equals(m) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko ||
				u || (b += this.$.clientLeft ? 1 : 0, c += this.$.clientTop ? 1 : 0);return {
					x : b,
					y : c
				}
			},
			...
			scrollIntoParent : function(a, b, c) {
				...
				function m(a, b) {
					...
					f = a.getWindow();f.equals(b) || (f = m(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y);return c
				}
				function x(a, b) {
				...
				d = d.y + F + x(this, "bottom") - (w.y + l) || 0;(0 > z || 0 < d) && g(0, !0 === b ? z : !1 === b ? d : 0 > z ? z : d);c && (0 > e || 0 < f) && g(0 > e ? e : f, 0)
			},
	...
	(function() {
		function a(a, b) {
			...
			var f,
				d = c.startContainer;
			f = c.endContainer;var e = c.startOffset,
				B = c.endOffset,
				g,
				l = this.guard,
				q = this.type,
		...
		CKEDITOR.dom.walker.invisible = function(a) {
			...
			return function(f) {
				b(f) ? f = 1 : (f.type == CKEDITOR.NODE_TEXT && (f = f.getParent()), f = f.$.offsetWidth <= c);return !!(a ^ f)
			}
		};
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = r(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(B) && f(b)) ? !0 : !1;return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, e) {
			...
			if (l && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(t, A)), c.append(q);else {
				...
				K = c;
				for (S = G; S <= I; S++)
					if (c = v[S], X = c.getPrevious(), c.equals(P[S])) b && (K = K.getChild(0));else {
		...
		function e(a) {
			return function() {
				...
				return this[a ?
					...
					!b && r(a) && (b = a);return p(a) && !(k(a) && a.equals(b))
				})
			}
		}
		var g = {
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark : function(a) {
				var b,
					...
					e,
					m = this.collapsed;
				b = this.document.createElement("span");b.data("cke-bookmark", 1);b.setStyle("display", "none");b.setHtml("\x26nbsp;");a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (m ? "C" : "S")));m || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(),
				e.collapse(), e.insertNode(c));
				e = this.clone();e.collapse(!0);e.insertNode(b);
			...
			createBookmark2 : function() {
				function a(b) {
					var f = b.container,
						...
						e;
					e = f;var g = d;
					e = e.type != CKEDITOR.NODE_ELEMENT || 0 === g || g == e.getChildCount() ? 0 : e.getChild(g - 1).type == CKEDITOR.NODE_TEXT && e.getChild(g).type == CKEDITOR.NODE_TEXT;e && (f = f.getChild(d -
						1), d = f.getLength());
				...
				return function(c) {
					...
					c && (a(e), b(e, this.root), d || (a(g), b(g, this.root)));return {
			...
			trim : function(a, b) {
				...
				c = this.endContainer;
				d = this.endOffset;b || e || !c || c.type != CKEDITOR.NODE_TEXT || (d ? (d >= c.getLength() || c.split(d), d = c.getIndex() + 1) :
			...
			enlarge : function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					var m = function(a, b) {
						...
						c.setStart(a, b);c.setEndAt(h, CKEDITOR.POSITION_BEFORE_END);
					...
					var g = this.getCommonAncestor(),
						...
						A,
						C;
					A = this.startContainer;var D = this.startOffset;
							...
							if (A = !1, q.type == CKEDITOR.NODE_COMMENT)
								...
								if (q.type == CKEDITOR.NODE_TEXT) C = q.getText(), d.test(C) && (q = null), A = /[\s\ufeff]$/.test(C);
									...
									if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
										...
										if (d.test(C))
											q = null;else
											for (var D = q.$.getElementsByTagName("*"), M = 0, H; H = D[M++];)
					...
					A = this.endContainer;D = this.endOffset;l = q = null;n = t = !1;A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(D)).length ? t = !0 : (t = !A.getLength(), D == A.getLength() ? (q = A.getNext()) || (l = A.getParent()) : m(A, D) && (l = A.getParent())) : (q = A.getChild(D)) || (l = A);
					for (; l ||
						q;) {
						if (l && !q) {
							!n && l.equals(g) && (n = !0);
							...
							if (q.type == CKEDITOR.NODE_TEXT) C = q.getText(), m(q, 0) || (q = null), A = /^[\s\ufeff]/.test(C);
								...
								if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark"))
									if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
										...
										if (d.test(C))
											q = null;else
											for (D = q.$.getElementsByTagName("*"), M = 0; H = D[M++];)
												if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) {
													q = null;break
										}
										q && (A = !!C.length)
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					l = new CKEDITOR.dom.range(this.root);h = this.root;l.setStartAt(h, CKEDITOR.POSITION_AFTER_START);l.setEnd(this.startContainer,
						this.startOffset);l = new CKEDITOR.dom.walker(l);var p,
						Q,
						P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
							br : 1
						} : null),
						v = null,
						G = function(a) {
						...
						e = function(a) {
							var b = G(a);
							!b && a.is && a.is("br") && (Q = a);return b
						};
					l.guard = G;l = l.lastBackward();p = p || h;this.setStartAt(p, !p.is("br") && (!l && this.checkStartOfBlock() || l && p.contains(l)) ?
					...
					l = this.clone();l.collapse();l.setEndAt(h, CKEDITOR.POSITION_BEFORE_END);l = new CKEDITOR.dom.walker(l);l.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : G;p = v = Q = null;l = l.lastForward();
			...
			shrink : function(a, b, c) {
				if (!this.collapsed) {
					...
					var d = this.clone(),
						...
						k = 1,
						r = 1;
					e && e.type == CKEDITOR.NODE_TEXT && (g ? g >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), k = 0) : d.setStartBefore(e));m && m.type == CKEDITOR.NODE_TEXT && (h ? h >= m.getLength() ? d.setEndAfter(m) :
			...
			insertNode : function(a) {
				...
				c ? a.insertBefore(c) : b.append(a);a.getParent() && a.getParent().equals(this.endContainer) &&
			...
			setEnd : function(b, c) {
				...
				this.endOffset = c;this.startContainer || (this._setStartContainer(b), this.startOffset = c);a(this)
			},
			...
			splitBlock : function(a, b) {
				...
				d = m && this.checkEndOfBlock();this.deleteContents();e && e.equals(m) &&
				(d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(m, CKEDITOR.POSITION_AFTER_END), m = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (m = this.splitElement(e, b || !1), e.is("ul", "ol") || e.appendBogus()));return {
					previousBlock : e,
					nextBlock : m,
					wasStartOfBlock : c,
					wasEndOfBlock : d,
			...
			checkBoundaryOfElement : function(a, b) {
				var d = b == CKEDITOR.START,
					e = this.clone();
				e.collapse(d);e[d ? "setStartAt" : "setEndAt"](a, d ? CKEDITOR.POSITION_AFTER_START :
			...
			checkStartOfBlock : function() {
				var a = this.startContainer,
					c = this.startOffset;
				CKEDITOR.env.ie && c && a.type == CKEDITOR.NODE_TEXT && (a = CKEDITOR.tools.ltrim(a.substring(0, c)), h.test(a) && this.trim(0, 1));this.trim();
			...
			checkEndOfBlock : function() {
				var a = this.endContainer,
					c = this.endOffset;
				CKEDITOR.env.ie && a.type == CKEDITOR.NODE_TEXT && (a = CKEDITOR.tools.rtrim(a.substring(c)), h.test(a) && this.trim(1, 0));this.trim();
			...
			moveToElementEditablePosition : function(a, b) {
				...
				for (var c = 0; a;) {
					...
					var d = a,
						e = c,
						m = void 0;
					d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (m = d[b ? "getLast" : "getFirst"](r));e || m || (m = d[b ? "getPrevious" : "getNext"](r));
					a = m
				}
				return !!c
			},
			...
			scrollIntoView : function() {
				var a = new CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", this.document),
					...
					e = this.clone();
				e.optimize();
				(d = e.startContainer.type == CKEDITOR.NODE_TEXT) ? (c = e.startContainer.getText(), b = e.startContainer.split(e.startOffset), a.insertAfter(e.startContainer)) : e.insertNode(a);a.scrollIntoView();
	...
	(function() {
		...
		function b(a, c, e, g) {
			...
			if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(c)) return b(a,
					c, e, g.remaining);
			c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);
			c = c.createIterator();
		...
		a.prototype = {
			getNextParagraph : function(a) {
				...
				if (!this._.started) {
					...
					m.shrink(CKEDITOR.SHRINK_ELEMENT, !0);J && m.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);w && m.setEndAt(x.block, CKEDITOR.POSITION_AFTER_START);
					k = m.endContainer.hasAscendant("pre", !0) || m.startContainer.hasAscendant("pre", !0);m.enlarge(this.forceBrBreak && !k || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
					...
					if (k && !J)
						for (; !x.getNext(h) && !u;) {
							...
							if (q.isBlockBoundary(this.forceBrBreak && !w && {
								...
								J = 1;
								F = 0;u || q.equals(m);k.setEndAt(q, CKEDITOR.POSITION_BEFORE_END);break
							}
							x = q;
							F = 1;
							u = x.equals(m);
	...
	(function() {
		function a(a, b, c, d, l) {
			...
			for (e in b) {
				...
				q = "boolean" == typeof q ? {} : "function" == typeof q ? {
					match : q
				} : M(q);"$" != e.charAt(0) && (q.elements = e);c && (q.featureName = c.toLowerCase());var n = q;
				n.elements = k(n.elements, /\s+/) || null;
				n.propertiesOnly = n.propertiesOnly || !0 === n.elements;var f = /\s*,\s*/,
					t = void 0;
				for (t in Q) {
					n[t] = k(n[t], f) || null;var m = n,
						g = P[t],
						E = k(n[P[t]], f),
						v = n[t],
						A = [],
			...
			for (d = a.length; c < d; ++c) {
				...
				for (t in P) {
					...
					g = E;g.length && (n[f] = g, m = !1)
				}
				n.nothingRequired = m;
				n.noProperties = !(n.attributes || n.classes || n.styles);
				if (!0 === e.elements ||
					null === e.elements) l[q ? "unshift" : "push"](e);else
					for (h in n = e.elements,
						delete e.elements
						, n)
						if (b[h]) b[h][q ? "unshift" : "push"](e);else
							b[h] = [ e ]
			}
		}
		function d(a, c, d, l) {
		...
		function z(a, b, l, e) {
			...
			if (e.doFilter) {
				...
				if (!a.allAttributes)
					for (G in t) C[G] || (H.test(G) ? G == (D = G.replace(/^data-cke-saved-/, "")) || C[D] || (
						delete t[G]
						, k = !0) : (
							delete t[G]
							, k = !0));
				...
				if (!a.allClasses ||
					...
					A.length && (t["class"] = A.sort().join(" "));v && A.length < v.split(/\s+/).length && (k = !0)
				} else v && (t["class"] = v);
				k && (n = 1);
		...
		function l(a, b, c) {
			...
			if (D.$empty[d] || !a.children.length)
				"hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
					check : "it",
					el : a.parent
				}), a.remove());
			else if (D.$block[d] || "tr" == d)
				if ("br" == b) a.previous && !F(a.previous) && (b = w(), b.insertBefore(a)), a.next && !F(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();else {
					var d = a.children,
						l;
					b:{
					l = D[b];
		...
		CKEDITOR.filter.prototype = {
			allow : function(b, c, d) {
				...
				if ("string" == typeof b)
					...
					};d && (d = M(d), l.classes = d["class"] ? d["class"].split(/\s+/) : null, l.requiredClasses = l.classes,
					delete d["class"]
					, l.attributes = d, l.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
			...
			applyTo : function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						...
						d = CKEDITOR.htmlParser.fragment.fromHtml(d);1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, l, c, g);
						c = !c.length}c || q.push(a)
					}
				}, null, !0);q.length && (f = !0);
				var m;
				a = [];
			...
			disallow : function(b) {
				...
				"string" == typeof b && (b = f(b));a(this, b, null, this.disallowedContent, this._.disallowedRules);return !0
			},
			...
			check : function(a, b, c) {
				...
				if ("string" == typeof a) {
					...
					d.children = [];n.length && (d.attributes["class"] = n.join(" "));l && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles));
					l = d
				...
				b = 0 < t.length ? !1 : CKEDITOR.tools.objectCompare(l.attributes, n.attributes, !0) ? !0 : !1;"string" == typeof a && (this._.cachedChecks[e] = b);return b
			},
		...
		K = CKEDITOR.filter.transformationsTools = {
			...
			splitBorderShorthand : function(a) {
				...
				if (a.styles.border) {
					...
					a.styles["border-style"] = a.styles["border-style"] || (a.styles.border.match(/(none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit)/) || [])[0];a.styles["border-style"] ||
					delete a.styles["border-style"];
		...
		CKEDITOR.focusManager.prototype = {
			...
			add : function(a, d) {
				...
				if (!b || b != this) {
					...
					a.on(b, e.focus, this);a.on(c, e.blur, this);d && (CKEDITOR.event.useCapture = 0);a.setCustomData("focusmanager", this);a.setCustomData("focusmanager_handlers", e)
				}
			},
			remove : function(a) {
				a.removeCustomData("focusmanager");
				var d = a.removeCustomData("focusmanager_handlers");
				a.removeListener("blur", d.blur);a.removeListener("focus", d.focus)
			}
		}
	})();
	...
	CKEDITOR.scriptLoader = function() {
		...
		return {
			load : function(b, c, e, g) {
				...
				if (0 === h) f(!0);else {
					var B = function(a, b) {
							(b ? p : r).push(a);0 >= --h && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), f(b))
						},
						u = function(b, c) {
							a[b] = 1;
							var e = d[b];
			...
			queue : function() {
				...
				return function(d, g) {
					...
					c.push({
						scriptUrl : d,
						callback : function() {
							g && g.apply(this, arguments);c.shift();a.call(k)
						}
			...
			for (var c = this.loaded, e = this.registered, g = [], k = {}, h = {}, p = 0; p < a.length; p++) {
				...
				if (r)
					if (c[r] || e[r])
						...
						g.push(f);f in k || (k[f] = []);k[f].push(r)
				}
			}
			CKEDITOR.scriptLoader.load(g, function(a, e) {
				if (e.length)
					throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".');
				...
				k = function(b) {
					a.call(this, b, function(a) {
						...
						if (b.length) k.call(this,
								b);else {
							for (f in g) h = g[f], h.onLoad && !h.onLoad._called && (!1 === h.onLoad() &&
								delete g[f]
								, h.onLoad._called = 1);
							c && c.call(e || window, g)
						}
	...
	(function() {
		...
		function h(a, b) {
			a.on("customConfigLoaded", function() {
				...
				a.filter = a.activeFilter = new CKEDITOR.filter(a);p(a)
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			destroy : function(a) {
				this.fire("beforeDestroy");!a && u.call(this);this.editable(null);this.filter && (this.filter.destroy(),
				delete this.filter
				);
			...
			getSelectedHtml : function(a) {
				...
				b = e ? d : b.getHtmlFromRange(c[0]);return a ? b.getHtml() : b
			},
			extractSelectedHtml : function(a, b) {
				...
				d = d[0];
				c = c.extractHtmlFromRange(d, b);b || this.getSelection().selectRanges([ d ]);return a ? c.getHtml() : c
			},
			focus : function() {
			...
			setKeystroke : function() {
				for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [ [].slice.call(arguments,
							0) ], c, d, e = b.length; e--;) c = b[e], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d :
						delete a[c]
			},
				...
				for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
					...
					if (k) k.push(c[0]);
						...
						if (e = e.toLowerCase(), !/="/.test(e)) {
							...
							this.onTagOpen(e, h, c);!k && CKEDITOR.dtd.$cdata[e] && (k = [])
						}
	...
	(function() {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function(g, k, h) {
			...
			y.onTagOpen = function(e, n, f, g) {
				n = new CKEDITOR.htmlParser.element(e, n);n.isUnknown && f && (n.isEmpty = !0);
				n.isOptionalClose = g;
				if (a(n)) x.push(n);else {
					...
					if ("br" == e) J.push(n);else {
						for (; !(g = (f = w.name) ? CKEDITOR.dtd[f] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || w.isUnknown || g[e]);)
							...
							else if (f in CKEDITOR.dtd.$inline && x.unshift(w), w.parent) B(w, w.parent, 1);else {
								n.isOrphan = 1;break
						}
						p(e);r();
						n.parent = w;
			...
			y.onTagClose = function(a) {
				...
				if (l != m) {
					...
					w = l;l._.isBlockLike && r();B(l, l.parent);l == w && (w = w.parent);
					x = x.concat(d)
				}
				"body" == a && (h = !1)
			};
			...
			y.onComment = function(a) {
				r();p();w.add(new CKEDITOR.htmlParser.comment(a))
			};y.parse(g);
	...
	(function() {
		...
		function f(a, b) {
			return a.replace(b, function(a, b, c) {
				0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e"
			})
		}
		function B(a) {
		...
		function m(a, b) {
			...
			a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function(a) {
				return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(a, b) {
					l[l.id] = decodeURIComponent(b);return "{cke_protected_" + l.id++ + "}"
				})
		...
		CKEDITOR.htmlDataProcessor = function(b) {
			...
			this.writer = new CKEDITOR.htmlParser.basicWriter;c.addRules(q);c.addRules(n, {
				applyToAll : !0
			});c.addRules(a(b, "data"), {
				applyToAll : !0
			});l.addRules(t);l.addRules(A, {
				applyToAll : !0
			});l.addRules(a(b, "html"), {
				applyToAll : !0
				...
				l = b.document.createElement(l);l.setHtml("a" + c);
				c = l.getHtml().substr(1);
				c = c.replace(new RegExp("data-cke-" + CKEDITOR.rnd + "-", "ig"), "");e && (c = c.replace(/^<pre>|<\/pre>$/gi, ""));
				c = c.replace(v, "$1$2");
				c = B(c);
				c = z(c);
				l = !1 === a.fixForBody ? !1 :
					d(a.enterMode, b.config.autoParagraph);
				c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, l);l && (e = c, !e.children.length && CKEDITOR.dtd[e.name][l] && (l = new CKEDITOR.htmlParser.element(l), e.add(l)));
				a.dataValue = c
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml : function(a, b, c, d) {
				var l = this.editor,
					...
					n,
					q;
				b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, f = b.filter, n = b.enterMode, q = b.protectedWhitespaces) : e = b;e || null === e || (e = l.editable().getName());return l.fire("toHtml", {
					dataValue : a,
					context : e,
					fixForBody : c,
					dontFilter : d,
			...
			toDataFormat : function(a, b) {
				var c,
					d,
					l;
				b && (c = b.context, d = b.filter, l = b.enterMode);c || null === c || (c = this.editor.editable().getName());return this.editor.fire("toDataFormat", {
					dataValue : a,
				...
				elements : {
					$ : function(a) {
						...
						if (b) {
							...
							for (var c = [ "name", "href", "src" ], d, l = 0; l < c.length; l++) d = "data-cke-saved-" + c[l], d in b &&
								delete b[c[l]]
						}
						return a
					},
					table : function(a) {
						a.children.slice(0).sort(function(a, b) {
							var c,
								d;
							a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(F, a.name), d = CKEDITOR.tools.indexOf(F, b.name));-1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1);return c > d ?
								1 : -1
						})
					},
					param : function(a) {
	...
	(function() {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			writeHtml : function(a, b) {
				...
				a.openTagClose(g, this.isEmpty);this.writeChildrenHtml(a);this.isEmpty || a.closeTag(g)
			},
	...
	(function() {
		function a(a, e, g, k) {
			...
			k == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), h._.required = a.hasAttribute("required"), a.removeAttribute("required"));g && h.setData(g, null, !0);h.on("loaded", function() {
				b(h);k == CKEDITOR.ELEMENT_MODE_REPLACE && h.config.autoUpdateElement &&
				a.$.form && h._attachToForm();h.setMode(h.config.startupMode, function() {
					h.resetDirty();
					h.status = "ready";h.fireOnce("instanceReady");CKEDITOR.fire("instanceReady", null, h)
				})
		...
		function b(a) {
			...
			a.container = b;
			a.ui.contentsElement = a.ui.space("contents");h && a.ui.space("top").unselectable();p && a.ui.space("bottom").unselectable();
			d = a.config.width;
		...
		CKEDITOR.editor.prototype.setMode = function(a, b) {
			...
			if (a != d.mode && k && k[a]) {
				...
				if (d.mode) {
					...
					d._.previousModeData = p = d.getData(1);"source" == d.mode && k == p && (d.fire("lockSnapshot", {
						forceUpdate : !0
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
			...
			}) : h;k.setSize("width", a, !0);r && (r.style.width = "1%");
			var f = (k.$.offsetHeight || 0) - (p.$.clientHeight ||
					0),
				h = Math.max(b - (d ? 0 : f), 0);
			b = d ? b + f : b;p.setStyle("height", h + "px");r && (r.style.width = "100%");this.fire("resize", {
				outerHeight : b,
				contentsHeight : h,
	...
	(function() {
		...
		function g(a) {
			...
			if (e.startPath().contains(f)) {
				var g = e.clone();
				g.collapse(1);g.setStartAt(a, CKEDITOR.POSITION_AFTER_START);
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto : {
				...
				insertHtml : function(a, b, c) {
					var d = this.editor;
					d.focus();d.fire("saveSnapshot");c || (c = d.getSelection().getRanges()[0]);m(this, b || "html", a, c);c.select();p(this);this.editor.fire("afterInsertHtml", {})
				},
				...
				insertElement : function(a, b) {
					...
					b || (b = d.getRanges()[0]);this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
						CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) {
						return c(a) && !z(a)
					})) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));d.selectRanges([ b ]);p(this)
				},
				...
				insertElementIntoRange : function(a, b) {
					...
					var g,
						k;
					if (f)
						for (; (g = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[g.getName()]) && (!k || !k[e]);) g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
				...
				fixInitialSelection : function() {
					...
					else if (this.hasFocus) this.focus(), a();else this.once("focus", function() {
							a()
						},
							null, null, -999)
				},
				getHtmlFromRange : function(a) {
					...
					a = {
						...
						range : a.clone()
					};w.eol.detect(a, this);w.bogus.exclude(a);w.cell.shrink(a);
					a.fragment = a.range.cloneContents();w.tree.rebuild(a, this);w.eol.fix(a, this);return new CKEDITOR.dom.documentFragment(a.fragment.$)
				},
				...
				setup : function() {
					...
					if (!this.is("textarea")) {
						...
						t = e.getCustomData("stylesheet_ref") || 0;e.setCustomData("stylesheet_ref", t + 1);this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling);this.attachListener(this, "click", function(a) {
							a = a.data;
								...
								if (d.collapsed) a:{var e = b.block;
									if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
										...
										if (!d || d && d.contains(e))
											...
											n = a.getSelection();
											f = n.createBookmarks();(c ? e : d).moveChildren(c ?
												d : e, !1);b.lastElement.mergeSiblings();r(e, d, !c);n.selectBookmarks(f);
											b = !0
										}
									} else
		...
		m = function() {
			...
			function b(c, d) {
				...
				-1 < D && (g[D].firstNotAllowed = 1);-1 < m && (g[m].lastNotAllowed = 1);return g
			}
			function d(b, c) {
				var e = [],
					f = b.getChildren(),
				...
				for (h && e.push(" "); t < q; t++) g = f.getItem(t), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g);
				h && e.push(" ");return e
			}
			function e(b) {
			...
			function g(b, c, d, e) {
				var f = b.clone(),
					n,
					q;
				f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);(n = (new CKEDITOR.dom.walker(f)).next()) && a(n) && m[n.getName()] && (q = n.getPrevious()) && a(q) && !q.getParent().equals(b.startContainer) && d.contains(q) && e.contains(n) && n.isIdentical(q) &&
			...
			return function(m, v, G, E) {
				...
				if (!E.checkReadOnly()) {
					...
					if (!v.collapsed) {
						...
						I && !I.equals(B) && !I.contains(B) && v.checkEndOfBlock() && m.zombies.push(I);v.deleteContents()
					}
					for (; (u = e(v)) && a(u) && u.isBlockBoundary() && K.contains(u);) v.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
					g(v, m.blockLimit, K, L);H && (v.setEndBefore(H), v.collapse(), H.remove());
					H = v.startPath();
					if (I = H.contains(f, !1, 1)) v.splitElement(I),
						m.inlineStylesRoot = I, m.inlineStylesPeak = H.lastElement;
					H = v.createBookmark();(I = H.startNode.getPrevious(c)) && a(I) && f(I) && E.push(I);(I = H.startNode.getNext(c)) && a(I) && f(I) && E.push(I);
					...
					if (H = G) {
						...
						u = H.document.createElement("body");u.setHtml(G);z && (u.getFirst().remove(), u.getLast().remove());
						if ((z = H.startPath().block) && (1 != z.getChildCount() || !z.getBogus())) a:{var w;
							if (1 ==
								...
								w.moveChildren(w.getParent(1));w.remove()
							}
						}
						m.dataWrapper = u;
						H = G
					...
					if (H) {
						...
						for (D(v, w); E < v.length; E++) {
							...
							if (y)
								...
								L.lastNotAllowed && E < v.length - 1 && ((J = B ? K : J) && w.setEndAt(J, CKEDITOR.POSITION_AFTER_START), I = 0);w.collapse()
							}
						}
					...
					if (!m.dontMoveCaret) {
						for (N = e(O); N && a(N) && !N.is(p.$empty);) {
							if (N.isBlockBoundary()) O.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END);else {
								if (f(N) && N.getHtml().match(/(\s|&nbsp;)$/g)) {
									T = null;break
								}
								T = O.clone();T.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END)
							}
							N = N.getLast(c)
						}
						T && O.moveToRange(T)
		...
		x = function() {
			...
			return function(d) {
				...
				f = a(f).lastBackward();f || (f = d.clone(), f.setEndAt(e, CKEDITOR.POSITION_BEFORE_END), f = a(f).lastForward(), g = !0);f || (f = e);
		...
		w = {
			eol : {
				detect : function(a, b) {
					...
					d.collapse(1);e.collapse();f.block && d.checkBoundaryOfElement(f.block, CKEDITOR.END) && (c.setStartAfter(f.block), a.prependEolBr = 1);g.block && e.checkBoundaryOfElement(g.block, CKEDITOR.START) && (c.setEndBefore(g.block), a.appendEolBr = 1)
				},
				fix : function(a, b) {
					var c = b.getDocument(),
						d;
				...
				list : {
					...
					merge : function(a, c) {
						if (a.mergeListBookmark) {
							...
							a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), l = l.contains(CKEDITOR.dtd.$listItem), f.equals(l) || b(l, d, e));d.remove();e.remove()
						}
					}
				},
				block : {
					...
					merge : function(a, c) {
						if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
							var d = a.mergeBlockBookmark.startNode,
								...
								f = f.block,
								l = l.block;
							f && l && !f.equals(l) && b(l, d, e);d.remove();e.remove()
						}
					}
				},
				table : function() {
					function a(c) {
						...
						l.guard = function(a, l) {
							...
							else if (!l && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f);else {
								if (h = !l)
									h = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n ||
										b(a, n));
					...
					return {
						...
						detectRanges : function(e, f) {
							...
							v = v.contains("table");
							h = h.contains("table");
							if (v || h) v && h && b(v, h) ? (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_START), g = l.clone(), g.setEndAt(v, CKEDITOR.POSITION_AFTER_END), k = l.clone(), k.setStartAt(h, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : v ? h || (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), l.setEndAt(v, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(h, CKEDITOR.POSITION_BEFORE_START), l.setStartAt(h, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = k ? k : a(l)
						},
						...
						purge : function(a) {
							if (a.purgeTableBookmark) {
								var b = a.doc,
									c = a.range.clone(),
									b = b.createElement("p");
								b.insertBefore(a.purgeTableBookmark.startNode);c.moveToBookmark(a.purgeTableBookmark);
	...
	(function() {
		...
		function d() {
			x = !0;m || (b.call(this), m = CKEDITOR.tools.setTimeout(b, 200, this))
		}
		function b() {
			m = null;x && (CKEDITOR.tools.setTimeout(a, 0, this), x = !1)
		}
		function c(a) {
		...
		function g(a) {
			k(a, !1);var b = a.getDocument().createText(z);
			...
			for (var b = 0; b < a.length; b++) {
				...
				if (!c.collapsed) {
					...
					var f = c.startOffset,
						g = c.endOffset,
						h = c.clone();
					d && d.type == CKEDITOR.NODE_TEXT && (f >= d.getLength() ? h.setStartAfter(d) : h.setStartBefore(d));e && e.type == CKEDITOR.NODE_TEXT && (g ? h.setEndAfter(e) : h.setEndBefore(e));
					d = new CKEDITOR.dom.walker(h);
					d.evaluator = function(d) {
						if (d.type == CKEDITOR.NODE_ELEMENT &&
							d.isReadOnly()) {
							var e = c.clone();
							c.setEndBefore(d);c.collapsed && a.splice(b--, 1);d.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d), e.collapsed || a.splice(b + 1, 0, e));return !0
						}
						return !1
					};d.next()
				}
				...
				function b(a) {
					return function(b) {
						var c = b.editor,
							d = c.createRange(),
							e;
						(e = d.moveToClosestEditablePosition(b.selected, a)) || (e = d.moveToClosestEditablePosition(b.selected, !a));e && c.getSelection().selectRanges([ d ]);c.fire("saveSnapshot");b.selected.remove();e || (d.moveToElementEditablePosition(c.editable()), c.getSelection().selectRanges([ d ]));c.fire("saveSnapshot");return !1
					}
				}
				var c = a(),
					d = a(1);
		...
		CKEDITOR.on("instanceCreated", function(b) {
			...
			e.on("contentDom", function() {
				function b() {
					v = new CKEDITOR.dom.selection(e.getSelection());v.lock()
				}
				function c() {
					l.removeListener("mouseup", c);q.removeListener("mouseup", c);var a = CKEDITOR.document.$.selection,
						b = a.createRange();
				...
				CKEDITOR.env.gecko && g.attachListener(g, "focus",
					function(a) {
						a.removeListener();0 !== p && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select())
					}, null, null, -2);g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
					p && CKEDITOR.env.webkit && (p = e._.previousActive && e._.previousActive.equals(f.getActive())) && null != e._.previousScrollTop && e._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = e._.previousScrollTop);e.unlockSelection(p);
					p = 0
				}, null, null, -1);g.attachListener(g,
					"mousedown", function() {
						p = 0
					});
							...
							q.on("mousedown", function(a) {
								function b(a) {
									...
									if (E) {
										...
										} catch (d) {} E.setEndPoint(0 > I.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);E.select()
									}
								}
								function c() {
								...
								if (a.getTarget().is("html") && a.$.y < q.$.clientHeight && a.$.x < q.$.clientWidth) {
									...
									I = E.duplicate();q.on("mousemove", b);l.on("mouseup", c);q.on("mouseup", c)
								}
							})
						}
				...
				g.attachListener(g, "selectionchange", a,
					e);g.attachListener(g, "keyup", d, e);g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
				...
				e.unlockSelection();CKEDITOR.env.webkit && c()
		...
		CKEDITOR.dom.selection.prototype = {
				...
				var a = B ? function() {
					...
					var b = function(b, c) {
						...
						for (var e = d.children, f, l, g = b.duplicate(), h = 0, k = e.length - 1, v = -1, n, m; h <= k;)
							if (v = Math.floor((h + k) / 2), f = e[v], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n)
								k = v - 1;
							else if (0 > n)
								h = v + 1;else return {
									container : d,
						...
						if (-1 == v || v == e.length - 1 && 0 > n) {
							g.moveToElementText(d);g.setEndPoint("StartToStart", b);
							g = g.text.replace(/(\r\n|\r)/g, "\n").length;
							e = d.childNodes;
						...
						g.collapse(0 < n ? !0 : !1);g.setEndPoint(0 < n ? "StartToStart" : "EndToStart", b);
						g = g.text.replace(/(\r\n|\r)/g, "\n").length;
						if (!g) return {
								container : d,
								offset : a(f) + (0 < n ? 0 : 1)
						...
						if (d == CKEDITOR.SELECTION_ELEMENT) {
							for (var d = [], e = 0; e < c.length; e++) {
								for (var f = c.item(e), g = f.parentNode, l = 0, a = new CKEDITOR.dom.range(this.root); l < g.childNodes.length && g.childNodes[l] != f; l++)
									;
								a.setStart(new CKEDITOR.dom.node(g), l);a.setEnd(new CKEDITOR.dom.node(g), l + 1);d.push(a)
							}
							return d
						}
						return []
			...
			unlock : function(a) {
				if (this.isLocked) {
					if (a) var b = this.getSelectedElement(),
							c = !b && this.getRanges(),
							d = this.isFake;
					this.isLocked = 0;this.reset();a && (a = b || c[0] && c[0].getCommonAncestor()) &&
			...
			selectRanges : function(a) {
				...
				if (a.length)
					if (this.isLocked) {
						...
						this.unlock();this.selectRanges(a);this.lock();f && !f.equals(this.root) && f.focus()
					} else {
						var h;
						a:{var m,
							p;
							...
							if (B) {
								...
								if ((c = h.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
									c.getName() in F && (!c.is("a") || !c.getText())) try {
										y = c.$.createControlRange();y.addElement(c.$);y.select();return
									} catch (w) {}
								...
								y = h.createBookmark();
								b = y.startNode;a || (f = y.endNode);
								y = h.document.$.body.createTextRange();y.moveToElementText(b.$);y.moveStart("character", 1);
								f ? (m = h.document.$.body.createTextRange(),
								m.moveToElementText(f.$), y.setEndPoint("EndToEnd", m), y.moveEnd("character", -1)) : (r = b.getNext(p), u = b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(m)) && (u || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), u = h.document.createElement("span"), u.setHtml("\x26#65279;"), u.insertBefore(b), r && h.document.createText("﻿").insertBefore(b));h.setStartBefore(b);b.remove();
								...
								for (y = 0; y < a.length; y++) {
									if (y < a.length - 1 && (r = a[y], u = a[y + 1], m = r.clone(), m.setStart(r.endContainer, r.endOffset), m.setEnd(u.startContainer, u.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), h = m.getCommonAncestor(), m = m.getEnclosedNode(), h.isReadOnly() || m && m.isReadOnly()))) {
										u.setStart(r.startContainer, r.startOffset);a.splice(y--, 1);continue
									}
									h = a[y];
									u = this.document.$.createRange();
									h.collapsed && CKEDITOR.env.webkit && e(h) && (m = g(this.root), h.insertNode(m), (r = m.getNext()) && !m.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (k(this.root), h.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : h.moveToPosition(m, CKEDITOR.POSITION_AFTER_END));u.setStart(h.startContainer.$, h.startOffset);try {
										u.setEnd(h.endContainer.$, h.endOffset)
									} catch (v) {
										if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) h.collapse(1), u.setEnd(h.endContainer.$, h.endOffset);else
											throw v;
									} f.addRange(u)
								}
							}
			...
			fake : function(a, b) {
				...
				void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label"));this.reset();p(c, b);
				var d = this._.cache,
	...
	(function() {
		...
		function b(c) {
			...
			if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);else {
				...
				n || (l = !0, n = CKEDITOR.dtd.span);c.enlarge(CKEDITOR.ENLARGE_INLINE, 1);c.trim();
				...
				if (!k) {
					var w = c.getCommonAncestor(),
						k = a(q, w),
						w = a(r, w);
					k && (u = k.getNextSourceNode(!0));w && (r = w)
				}
				for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
					...
					if (u.equals(r)) u = null, k = !0;else {
						...
						if (z && u.data("cke-bookmark")) {
							u = u.getNextSourceNode(!0);continue
						}
						...
						if (A)
							if (C = u.getParent(), A = h, D = g, F = l, !C || !(C.getDtd() || CKEDITOR.dtd.span)[D] && !F || A.parentRule && !A.parentRule(C))
								k = !0;else {
								if (t ||
		...
		function r(a, b) {
			...
			if (d && !e) {
				...
				if (CKEDITOR.env.ie) {
					...
					h.append(e);
					e.$.outerHTML = "\x3cpre\x3e" + g + "\x3c/pre\x3e";e.copyAttributes(h.getFirst());
					e = h.getFirst().remove()
				} else e.setHtml(g);
				b = e
			} else
				g ? b = u(c ? [ a.getHtml() ] : f(a), b) : a.moveChildren(b);
			b.replace(a);
			if (d) {
				var c = b,
					k;
		...
		function z(a, b) {
			...
			m(a, e, A[a.getName()]);f && (this._.definition.alwaysRemoveElement ?
		...
		CKEDITOR.style = function(a, b) {
			...
			this.type = a.type || (A[c] ? CKEDITOR.STYLE_BLOCK : C[c] ? CKEDITOR.STYLE_OBJECT :
				CKEDITOR.STYLE_INLINE);"object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT);
			this._ = {
				definition : a
			}
		};
		CKEDITOR.style.prototype = {
			apply : function(a) {
				...
				if (this.checkApplicable(a.elementPath(), a)) {
					...
					b || (this._.enterMode = a.activeEnterMode);t.call(this, a.getSelection(), 0, a);
					this._.enterMode = b
				}
			},
			remove : function(a) {
				...
				if (this.checkApplicable(a.elementPath(),
						a)) {
					var b = this._.enterMode;
					b || (this._.enterMode = a.activeEnterMode);t.call(this, a.getSelection(), 1, a);
					this._.enterMode = b
				}
			},
			applyToRange : function(a) {
				this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? g : null;return this.applyToRange(a)
			},
			removeFromRange : function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? p : this.type == CKEDITOR.STYLE_OBJECT ? k : null;return this.removeFromRange(a)
			},
	...
	CKEDITOR.dom.elementPath.prototype = {
		...
		contains : function(a, d, b) {
			...
			var e = this.elements,
				g = e.length;
			d && g--;b && (e = Array.prototype.slice.call(e, 0), e.reverse());
			for (d = 0; d < g; d++)
				if (c(e[d])) return e[d];
			return null
		},
	...
	(function() {
		function a(a, c, d) {
			...
			k.equals(p.getPrevious()) ? (c.startOffset = c.startOffset - k.getLength() - a.getPrevious().getLength(), k = a.getNext()) : k.equals(a.getPrevious()) && (c.startOffset -= k.getLength(), k = a.getNext());k.equals(p.getParent()) && c[h]++;k.equals(a.getParent()) && c[h]++;
	...
	(function() {
		...
		function b(a, b) {
			g[a] || (CKEDITOR.document.appendStyleSheet(d(a)), g[a] = 1);b && b()
		}
		function c(a) {
			var b = a.getById(k);
		...
		CKEDITOR.skin = {
			...
			getIconStyle : function(a, b, c, d, e) {
				...
				a = c || g && g.path || "";
				d = d || g && g.offset;
				e = e || g && g.bgsize || "16px";a && (a = a.replace(/'/g, "\\'"));return a && "background-image:url('" + CKEDITOR.getUrl(a) + "');background-position:0 " + d + "px;background-size:" + e + ";"
			}
		};CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			getUiColor : function() {
				return this.uiColor
...
*/
	...
	(function() {
		...
		CKEDITOR.dialog.prototype = {
			...
			show : function() {
				...
				null === CKEDITOR.dialog._.currentZIndex && (CKEDITOR.dialog._.currentZIndex = this._.editor.config.baseFloatZIndex);this._.element.getFirst().setStyle("z-index", CKEDITOR.dialog._.currentZIndex += 10);
				...
				CKEDITOR.tools.setTimeout(function() {
					this.layout();
					X(this);this.parts.dialog.setStyle("visibility", "");this.fireOnce("load", {});CKEDITOR.ui.fire("ready", this);this.fire("show", {});this._.editor.fire("dialogShow", this);this._.parentDialog || this._.editor.focusManager.lock();this.foreach(function(a) {
			...
			hide : function() {
				if (this.parts.dialog.isVisible()) {
					...
					var a = this._.element;
					a.setStyle("display", "none");this.parts.dialog.setStyle("visibility", "hidden");
			...
			addPage : function(a) {
				if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
					...
					c = CKEDITOR.dom.element.createFromHtml([ '\x3ca class\x3d"cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', d, '"', e.gecko && !e.hc ? "" : ' href\x3d"javascript:void(0)"',
						' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e" ].join(""));b.setAttribute("aria-labelledby", d);
					this._.tabs[a.id] = [ c, b ];this._.tabIdList.push(a.id);!a.hidden && this._.pageCount++;
					this._.lastTab = c;this.updateStyle();b.setAttribute("name", a.id);b.appendTo(this.parts.contents);c.unselectable();this.parts.tabs.append(c);a.accessKey && (S(this, this, "CTRL+" + a.accessKey, ca, da), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
				}
			},
			...
			CKEDITOR.ui.dialog = {
				uiElement : function(a, b, c, e, d, f, g) {
					if (!(4 > arguments.length)) {
						...
						k.id = n;
						var r = {};
						b.type && (r["cke_dialog_ui_" + b.type] = 1);b.className && (r[b.className] = 1);b.disabled && (r.cke_disabled = 1);
						...
						this.registerEvents(b);this.accessKeyUp && this.accessKeyDown && b.accessKey && S(this, a, "CTRL+" + b.accessKey);
						var t = this;
						a.on("load", function() {
							...
							if (b) {
								...
								b.on("focus", function() {
									a._.tabBarMode = !1;
									a._.hasFocus = !0;t.fire("focus");c && this.addClass(c)
								});b.on("blur", function() {
				...
				hbox : function(a, b, c, e, d) {
					if (!(4 > arguments.length)) {
						...
						d && d.align && (m.align = d.align);CKEDITOR.ui.dialog.uiElement.call(this, a, d || {
								type : "hbox"
							}, e, "table", {}, m, function() {
				...
				vbox : function(a, b, c, e, d) {
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, a, d || {
								...
								b.push('style\x3d"');d && d.expand && b.push("height:100%;");b.push("width:" + v(g || "100%"), ";");CKEDITOR.env.webkit && b.push("float:none;");b.push('"');b.push('align\x3d"',
									CKEDITOR.tools.htmlEncode(d && d.align || ("ltr" == a.getParentEditor().lang.dir ? "left" : "right")), '" ');b.push("\x3e\x3ctbody\x3e");
								for (var e = 0; e < c.length; e++) {
									var k = [];
									b.push('\x3ctr\x3e\x3ctd role\x3d"presentation" ');g && k.push("width:" + v(g || "100%"));
									h ? k.push("height:" + v(h[e])) : d && d.expand && k.push("height:" + Math.floor(100 / c.length) + "%");d && void 0 !== d.padding && k.push("padding:" + v(d.padding));CKEDITOR.env.ie && CKEDITOR.env.quirks && f[e].align && k.push("text-align:" + f[e].align);0 < k.length && b.push('style\x3d"',
		...
		CKEDITOR.ui.dialog.vbox.prototype = new CKEDITOR.ui.dialog.hbox;(function() {
			...
			CKEDITOR.dialog.addUIElement("hbox", a);CKEDITOR.dialog.addUIElement("vbox",
				a)
		})();
	...
	CKEDITOR.config.coreStyles_superscript = {
		...
		function z(b) {
			function a() {
				...
				if (CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) {
					var c = function(a) {
						b.readOnly && "cut" == a.name || m.initPasteDataTransfer(a, b);a.data.preventDefault()
					};
					a.on("copy",
						c);a.on("cut", c);a.on("cut", function() {
			...
			function n(a, c) {
				...
				if (!d.getById("cke_pastebin")) {
					...
					CKEDITOR.env.webkit ? (g.append(l), l.addClass("cke_editable"), g.is("body") || (f = "static" != g.getComputedStyle("position") ? g : CKEDITOR.dom.element.get(g.$.offsetParent), f = f.getDocumentPosition().y)) : g.getAscendant(CKEDITOR.env.ie ?
						"body" : "html", 1).append(l);l.setStyles({
						position : "absolute",
					...
					(f = l.getParent().isReadOnly()) ? (l.setOpacity(0), l.setAttribute("contenteditable", !0)) : l.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");b.on("selectionChange", e, null, null, 0);
					if (CKEDITOR.env.webkit ||
						CKEDITOR.env.gecko)
						h = g.once("blur", e, null, null, -100);
					f && l.focus();
					f = new CKEDITOR.dom.range(l);f.selectNodeContents(l);
					var n = f.select();
					...
					setTimeout(function() {
						CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = r);h && h.removeListener();CKEDITOR.env.ie && g.focus();k.selectBookmarks(u);l.remove();
						var a;
			...
			function w() {
				...
				b.focus();f();var a = b.focusManager;
				a.lock();
			...
			function k(a) {
				if ("wysiwyg" == b.mode) switch (a.data.keyCode) {
					...
					case CKEDITOR.SHIFT + 45:
						a = b.editable();f();"paste" == m.mainPasteEvent && a.fire("beforepaste");
			...
			function u(a) {
				...
				d && m.canClipboardApiBeTrusted(c.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() {
					...
					c.dataValue = a.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig, "");d && q(b, c)
				})
			}
			function r() {
				if ("wysiwyg" == b.mode) {
			...
			function t(a) {
				...
				a = b.getSelection();var c = a.getRanges();
			...
			(function() {
				b.on("key", k);b.on("contentDom", a);b.on("selectionChange", function(b) {
					x = b.data.selection.getRanges()[0].checkReadOnly();r()
				});b.contextMenu && b.contextMenu.addListener(function(b, a) {
					x = a.getRanges()[0].checkReadOnly();return {
						cut : t("cut"),
						copy : t("copy"),
						paste : t("paste")
					}
				...
				function a(c, d, g, e, h) {
					...
					b.addCommand(d, g);b.ui.addButton && b.ui.addButton(c, {
						label : k,
						command : d,
						toolbar : "clipboard," + e
				...
				a("Cut", "cut", c("cut"), 10, 1);a("Copy", "copy", c("copy"), 20, 4);a("Paste",
					"paste", e(), 30, 8)
			})();
			b.getClipboardData = function(a, c) {
				...
				var h = !1,
					k = "auto",
					f = !1;
				c || (c = a, a = null);b.on("paste", d, null, null, 0);b.on("beforePaste", function(a) {
					a.removeListener();
					h = !0;
					k = a.data.type
				}, null, null, 1E3);!1 === w() && (b.removeListener("paste", d), h && b.fire("pasteDialog",
					e) ? (b.on("pasteDialogCommit", g), b.on("dialogHide", function(a) {
					a.removeListener();a.data.removeListener("pasteDialogCommit", g);setTimeout(function() {
						f || c(null)
					}, 10)
				})) : c(null))
			}
		...
		function B(b, a) {
			...
			a.match(/<div>(<br>|)<\/div>/) && (a = "\x3cp\x3e" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(a) {
				...
				}) + "\x3c/p\x3e"), a = a.replace(/<\/div><div>/g, "\x3cbr\x3e"), a = a.replace(/<\/?div>/g, ""));CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "\x3cbr\x3e")), -1 < a.indexOf("\x3cbr\x3e\x3cbr\x3e") && (a = "\x3cp\x3e" + a.replace(/(<br>){2,}/g, function(a) {
					return c(a.length / 4)
				}) + "\x3c/p\x3e"));return C(b, a)
		}
		function D() {
			function b() {
				var a = {},
		...
		function y(b, a, c) {
			a = CKEDITOR.htmlParser.fragment.fromHtml(a);var e = new CKEDITOR.htmlParser.basicWriter;
			c.applyTo(a, !0, !1,
		...
		function F(b) {
			...
			b.on("contentDom", function() {
				...
				function f(a, d, c) {
					...
					d && (g.dragRange = d);c && (g.dropRange = c);!1 === b.fire(a.name, g) && a.data.preventDefault()
				}
				function g(a) {
				...
				var d = b.editable(),
					...
					n = b.ui.space("top"),
					w = b.ui.space("bottom");
				a.preventDefaultDropOnElement(n);a.preventDefaultDropOnElement(w);d.attachListener(h, "dragstart", f);d.attachListener(b, "dragstart", a.resetDragDataTransfer, a, null, 1);d.attachListener(b, "dragstart", function(d) {
					a.initDragDataTransfer(d, b)
				}, null, null, 2);d.attachListener(b, "dragstart", function() {
				...
				}, null, null, 100);d.attachListener(h, "dragend", f);d.attachListener(b, "dragend", a.initDragDataTransfer, a, null, 1);d.attachListener(b, "dragend", a.resetDragDataTransfer, a, null, 100);d.attachListener(h, "dragover", function(a) {
					var b = a.data.getTarget();
				...
				}, null, null, 9999);d.attachListener(b, "drop", a.initDragDataTransfer, a, null, 1);d.attachListener(b, "drop", function(d) {
					if (d = d.data) {
						var g = d.dropRange,
							h = d.dragRange,
							f = d.dataTransfer;
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init : function(b) {
				...
				b.pasteFilter = c.get(a);z(b);F(b);CKEDITOR.dialog.add("paste", CKEDITOR.getUrl(this.path + "dialogs/paste.js"));
					...
					b.on("paste", function(a) {
						...
						if (!d.dataValue && "paste" == d.method && c && 1 == c.getFilesCount() && f != c.id && (c = c.getFile(0), -1 != CKEDITOR.tools.indexOf(e, c.type))) {
							...
							n.addEventListener("load", function() {
								a.data.dataValue = '\x3cimg src\x3d"' + n.result + '" /\x3e';b.fire("paste", a.data)
							}, !1);n.addEventListener("abort", function() {
								b.fire("paste", a.data)
				...
				b.on("paste", function(a) {
					...
					f = "html" == d || "html" == a.preSniffing ? "html" : A(e);"htmlifiedtext" == f && (e = B(b.config, e));
					"text" == d && "html" == f ? e = y(b, e, c.get("plain-text")) : k == CKEDITOR.DATA_TRANSFER_EXTERNAL && b.pasteFilter && !a.dontFilter && (e = y(b, e, b.pasteFilter));a.startsWithEOL && (e = '\x3cbr data-cke-eol\x3d"1"\x3e' + e);a.endsWithEOL && (e += '\x3cbr data-cke-eol\x3d"1"\x3e');"auto" == d &&
					...
					a = a.data;a.dataValue && (b.insertHtml(a.dataValue, a.type, a.range), setTimeout(function() {
						b.fire("afterPaste")
					}, 0))
				}, null, null, 1E3);b.on("pasteDialog", function(a) {
					setTimeout(function() {
		...
		CKEDITOR.plugins.clipboard = {
			...
			internalDrop : function(b, a, c, e) {
				var f = CKEDITOR.plugins.clipboard,
					...
					d,
					h;
				e.fire("saveSnapshot");e.fire("lockSnapshot", {
					dontUpdate : 1
				...
				f = a.clone().createBookmark(!1);h && (d = b.createBookmark(!1));
				b = d.startNode;
				a = d.endNode;
				h = f.startNode;a && b.getPosition(h) & CKEDITOR.POSITION_PRECEDING && a.getPosition(h) & CKEDITOR.POSITION_FOLLOWING && h.insertBefore(b);
				b = e.createRange();b.moveToBookmark(d);g.extractHtmlFromRange(b, 1);
				a = e.createRange();a.moveToBookmark(f);q(e, {
					dataTransfer : c,
					method : "drop",
					range : a
				}, 1);e.fire("unlockSnapshot")
			},
			getRangeAtDropPosition : function(b, a) {
				...
				else if (c.rangeParent) d.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), d.collapse(!0);else {
					...
					if (document.body.createTextRange) {
						...
						c = a.document.getBody().$.createTextRange();try {
							...
							if (h) {
								...
								d.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START);r.remove()
							} else {
								...
								q = m.getClientRect();
								e < q.left ? d.setStartAt(m, CKEDITOR.POSITION_AFTER_START) : d.setStartAt(m, CKEDITOR.POSITION_BEFORE_END);d.collapse(!0)
							}
						} catch (v) {
							return null
						}
		...
		CKEDITOR.plugins.clipboard.dataTransfer = function(b, a) {
			...
			this.id = this.getData(p);this.id || (this.id = "Text" == p ? "" : "cke-" + CKEDITOR.tools.getUniqueId());
			if ("Text" != p) try {
					this.$.setData(p, this.id)
				} catch (c) {} a && (this.sourceEditor = a, this.setData("text/html", a.getSelectedHtml(1)), "Text" == p || this.getData("text/plain") || this.setData("text/plain", a.getSelection().getSelectedText()))
		};
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			...
			cacheData : function() {
				function b(b) {
					b = a._.normalizeType(b);var c = a.getData(b);
					c && (a._.data[b] = c)
				}
				if (this.$) {
					var a = this,
		...
		CKEDITOR.ui.panel.prototype = {
			render : function(a, b) {
				this.getHolderElement = function() {
					...
					if (!a) {
						if (this.isFramed) {
							...
							}, this));a.write(h.output(CKEDITOR.tools.extend({
				...
				e = f.output(d);b && b.push(e);return e
			},
			...
			showBlock : function(a) {
				...
				b && b.hide();
				this._.currentBlock = a;CKEDITOR.fire("ariaWidget", d);
				a._.focusIndex = -1;
					...
					case "next":
						for (var e = this._.focusIndex, d = this.element.getElementsByTag("a"), c; c = d.getItem(++e);)
							if (c.getAttribute("_cke_focus") && c.$.offsetWidth) {
								this._.focusIndex = e;c.focus();
								break
						}
						return c ||
						b ? !1 : (this._.focusIndex = -1, this.onKeyDown(a, 1));case "prev":
						e = this._.focusIndex;
						...
						return c || b ? !1 : (this._.focusIndex = d.count(), this.onKeyDown(a, 1));case "click":
					case "mouseup":
	...
	(function() {
		function v(a, b, c, l, h) {
			h = CKEDITOR.tools.genKey(b.getUniqueId(), c.getUniqueId(), a.lang.dir, a.uiColor || "", l.css || "", h || "");var g = f[h];
		...
		CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
			...
			proto : {
				...
				showBlock : function(a, b, c, l, h, g) {
					...
					if (3 == c || 4 == c)
						n += b.$.offsetHeight - 1;
					this._.panel._.offsetParentId = b.getId();k.setStyles({
						top : n + "px",
						left : 0,
						display : ""
					});k.setOpacity(0);k.getFirst().removeStyle("width");this._.editor.focusManager.add(e);this._.blurSet || (CKEDITOR.event.useCapture = !0, e.on("blur", function(a) {
						function u() {
					...
					m.onEscape = CKEDITOR.tools.bind(function(a) {
						...
						var a = CKEDITOR.tools.bind(function() {
							...
							if (p.autoSize) {
								...
								b = p.element.$.scrollHeight;CKEDITOR.env.ie &&
							...
							q && (d -= k.$.offsetWidth);k.setStyle("left", d + "px");
						...
						m.isLoaded ? a() : m.onLoad = a;CKEDITOR.tools.setTimeout(function() {
							var a = CKEDITOR.env.webkit && CKEDITOR.document.getWindow().getScrollPosition().y;
							this.focus();p.element.focus();CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = a);this.allowBlur(!0);this._.editor.fire("panelShow", this)
						}, 0, this)
		...
		CKEDITOR.menuItem = CKEDITOR.tools.createClass({
			...
			proto : {
				render : function(a, b, d) {
					...
					(p = this.icon);this.command && (f = e.getCommand(this.command), (f = e.getCommandKeystroke(f)) && (c = CKEDITOR.tools.keystrokeToString(e.lang.common.keyboard, f)));
					a = {
						id : h,
						name : this.name,
						iconName : p,
			...
			CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({
				...
				proto : {
					...
					open : function(a, e, f, d) {
						this.editor.focus();
						a = a || CKEDITOR.document.getDocumentElement();this.editor.selectionChange(1);this.show(a, e, f, d)
					}
				}
			})
		},
		...
		CKEDITOR.ui.button.prototype = {
			render : function(a, b) {
				...
				e.clickFn = q = CKEDITOR.tools.addFunction(function() {
					r && (a.unlockSelection(1), r = 0);e.execute();n.iOS && a.focus()
				});
				if (this.modes) {
					var m = {};
					a.on("beforeModeUnload", function() {
						a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED && (m[a.mode] = this._.state)
					}, this);a.on("activeFilterChange",
				...
				if (this.directional) a.on("contentDirChanged", function(b) {
						var c = CKEDITOR.document.getById(this._.id),
							d = c.getFirst();
						b = b.data;
						b != a.lang.dir ? c.addClass("cke_" + b) : c.removeClass("cke_ltr").removeClass("cke_rtl");d.setAttribute("style", CKEDITOR.skin.getIconStyle(l,
								...
								if (e && (b.push("\x3c/span\x3e"), k = e = 0), "/" === p) b.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');else {
									...
									for (var y = 0; y < x.length; y++) {
										...
										if (t) {
											var B = function(c) {
												c = c.render(a, b);
												u = n.items.push(c) - 1;0 < u && (c.previous = n.items[u - 1], c.previous.next = c);
												c.toolbar = n;
												c.onkey = g;
												c.onfocus = function() {
						...
						if (a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
							...
							a.on("destroy", function() {
								...
								exec : function(b) {
									...
									a.getFirst().setText(g ? "▲" : "◀");e.setStyle("height", f - (d.$.offsetHeight - h) + "px");b.fire("resize", {
			...
			if (g) {
				if (g = CKEDITOR.tools.search(c, function(a) {
					...
					if (d && (d = CKEDITOR.tools.indexOf(g.groups, d), 0 <= d)) {
						g.groups.splice(d + 1, 0, a);return
					}
	...
	CKEDITOR.config.toolbarLocation = "top";(function() {
		function q(a, e) {
			function l(c) {
				c = k.list[c];var d;
				c.equals(a.editable()) || "true" == c.getAttribute("contenteditable") ? (d = a.createRange(), d.selectNodeContents(c), d = d.select()) : (d = a.getSelection(), d.selectElement(c));CKEDITOR.env.ie && a.fire("selectionChange", {
					selection : d,
			...
			e.html += '\x3cspan id\x3d"' +
				p + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel + '\x3c/span\x3e\x3cspan id\x3d"' + p + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' + p + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';a.on("uiReady", function() {
				var c = a.ui.space("path");
				c && a.focusManager.add(c, 1)
			});
			k.onClick = l;var v = CKEDITOR.tools.addFunction(l),
				w = CKEDITOR.tools.addFunction(function(c, d) {
					var g = k.idBase,
						b;
					d = new CKEDITOR.dom.event(d);
					b = "rtl" == a.lang.dir;switch (d.getKeystroke()) {
					case b ?
							39:
							37:case 9:
						return (b = CKEDITOR.document.getById(g + (c + 1))) || (b = CKEDITOR.document.getById(g + "0")), b.focus(), !1;case b ? 37:
							39:case CKEDITOR.SHIFT + 9:
						return (b = CKEDITOR.document.getById(g + (c - 1))) || (b = CKEDITOR.document.getById(g + (k.list.length - 1))), b.focus(), !1;case 27:
						return a.focus(), !1;case 13:
					case 32:
						return l(c), !1
					}
			...
			a.on("selectionChange", function() {
				for (var c = [], d = k.list = [], g = [], b = k.filters, e = !0, l = a.elementPath().elements, f, u = l.length; u--;) {
					...
					f = h.data("cke-display-name") ? h.data("cke-display-name") :
						h.data("cke-real-element-type") ? h.data("cke-real-element-type") : h.getName();(e = h.hasAttribute("contenteditable") ? "true" == h.getAttribute("contenteditable") : e) || h.hasAttribute("contenteditable") || (r = 1);
				...
				g = n;g.setHtml(c.join("") + '\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e');a.fire("elementsPathUpdate", {
					space : g
				})
		...
		var y = {
			...
			e = "";
		CKEDITOR.env.gecko &&
		CKEDITOR.env.mac && (e += ' onkeypress\x3d"return false;"');CKEDITOR.env.gecko && (e += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;"');
		...
		function q(b, d, a) {
			a = b.config.forceEnterMode || a;"wysiwyg" == b.mode && (d || (d = b.activeEnterMode), b.elementPath().isContextFor("p") || (d = CKEDITOR.ENTER_BR, a = 1), b.fire("saveSnapshot"), d == CKEDITOR.ENTER_BR ? t(b, d, null, a) : u(b, d, null, a), b.fire("saveSnapshot"))
		}
		function v(b) {
	...
	CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
		...
		function m() {
			var a = this.getDialog(),
				c = a.getParentEditor();
			c._.filebrowserSe = this;var d = c.config["filebrowser" + k(a.getName()) + "WindowWidth"] || c.config.filebrowserWindowWidth || "80%",
				a = c.config["filebrowser" + k(a.getName()) + "WindowHeight"] || c.config.filebrowserWindowHeight ||
					"70%",
				b = this.filebrowser.params || {};
			b.CKEditor = c.name;
			b.CKEditorFuncNum = c._.filebrowserFn;b.langCode || (b.langCode = c.langCode);
			b = g(this.filebrowser.url, b);c.popup(b, d, a, c.config.filebrowserWindowFeatures || c.config.fileBrowserWindowFeatures)
		}
		function n() {
			var a = this.getDialog();
		...
		function p(a, c, d) {
			...
			{};
			b.CKEditor = a.name;
			b.CKEditorFuncNum = a._.filebrowserFn;b.langCode || (b.langCode = a.langCode);
			c.action = g(d.url, b);
			c.filebrowser = d
		}
		function l(a, c, d, b) {
				...
				for (var e, g = b.length; g--;)
					if (e = b[g], "hbox" != e.type && "vbox" != e.type && "fieldset" != e.type || l(a, c, d, e.children), e.filebrowser)
						if ("string" == typeof e.filebrowser && (e.filebrowser = {
							...
							e.filebrowser.url = f;
							e.hidden = !1;p(a, d.getContents(e["for"][0]).get(e["for"][1]), e.filebrowser)
			}
		}
		function h(a, c, d) {
			if (-1 !== d.indexOf(";")) {
		...
		CKEDITOR.plugins.add("filebrowser", {
			requires : "popup",
			init : function(a) {
				a._.filebrowserFn = CKEDITOR.tools.addFunction(q, a);a.on("destroy", function() {
	...
	(function() {
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			...
			proto : {
				...
				render : function(a, b) {
					function g() {
						if (this.getState() != CKEDITOR.TRISTATE_ON) {
							...
							a.readOnly && !this.readOnly && (c = CKEDITOR.TRISTATE_DISABLED);this.setState(c);this.setValue("");c != CKEDITOR.TRISTATE_DISABLED && this.refresh && this.refresh()
						}
					}
					var d = CKEDITOR.env,
						h = "cke_" + this.id,
						e = CKEDITOR.tools.addFunction(function(b) {
							l && (a.unlockSelection(1), l = 0);c.execute(b)
						}, this),
						f = this,
						c = {
							id : h,
							...
							execute : function(c) {
								...
								if (b.state != CKEDITOR.TRISTATE_DISABLED)
									if (f.createPanel(a), b.on) b.panel.hide();else {
										f.commit();
										var d = f.getValue();
										d ? b.list.mark(d) : b.list.unmarkAll();b.panel.showBlock(f.id, new CKEDITOR.dom.element(c), 4)
								}
							},
							clickFn : e
						};
					a.on("activeFilterChange", g, this);a.on("mode",
						g, this);a.on("selectionChange", g, this);!this.readOnly && a.on("readOnly", g, this);
				...
				createPanel : function(a) {
					if (!this._.panel) {
						...
						e.onShow = function() {
							...
							c._.on = 1;c.editorFocus && !a.focusManager.hasFocus && a.focus();
						...
						e.onHide = function(b) {
							this.element.removeClass(h);c.setState(c.modes && c.modes[a.mode] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
							c._.on = 0;
						...
						f.onClick = function(a, b) {
							c.onClick && c.onClick.call(c, a, b);e.hide()
						};
						this._.panel = e;
						this._.list = f;
						e.getBlock(this.id).onHide = function() {
							c._.on = 0;c.setState(CKEDITOR.TRISTATE_OFF)
						};this.init && this.init()
					}
				},
				setValue : function(a, b) {
				...
				add : function(a, b, d) {
					this._.items[a] = d || a;this._.list.add(a, b, d)
				},
				startGroup : function(a) {
			...
			if (!a.blockless) {
				...
				0 !== m && a.ui.addRichCombo("Format", {
					...
					onClick : function(b) {
						...
						b = d[b];
						var e = a.elementPath();
						a[b.checkActive(e, a) ? "removeStyle" : "applyStyle"](b);setTimeout(function() {
							a.fire("saveSnapshot")
						}, 0)
					},
					onRender : function() {
	...
	CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
		...
		function m(a) {
			...
			(e = c.getElementById("cke_shimscrpt")) && e.parentNode.removeChild(e);(e = c.getElementById("cke_basetagscrpt")) && e.parentNode.removeChild(e);
			...
			d = b.document.getElementsByTag("title").getItem(0);d.data("cke-title", d.getText());CKEDITOR.env.ie && (b.document.$.title = this._.docTitle);CKEDITOR.tools.setTimeout(function() {
				"unloaded" ==
				this.status && (this.status = "ready");b.fire("contentDom");this._.isPendingFocus && (b.focus(), this._.isPendingFocus = !1);setTimeout(function() {
					b.fire("dataReady")
				}, 0)
			}, 0, this)
		}
			...
			init : function(a) {
				a.config.fullPage && a.addFeature({
					...
					if (h) {
						...
						c.append(k, 1);d.setAttribute("aria-describedby", g)
					}
	...
	CKEDITOR.config.image_removeLinkByEmptyURL = !0;(function() {
		...
		function w(c) {
			function f(b) {
				...
				e && c.fire("contentDomInvalidated");return !0
			}
			for (var l = this, q = this.database, p = this.context, n = c.getSelection(), n = (n && n.getRanges()).createIterator(), d; d = n.getNextRange();) {
				...
				b && d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in p && (h = new CKEDITOR.dom.walker(d), h.evaluator = t, d.startContainer = h.next());b && d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in
		...
		CKEDITOR.plugins.add("indentlist", {
			...
			init : function(c) {
				function f(c) {
					...
					this.requiredContent = [ "ul", "ol" ];c.on("key",
						function(f) {
		...
		function n(c) {
			...
			c && "encode" != c && (b = {}, c.replace(/^([^(]+)\(([^)]+)\)$/, function(a, c, e) {
				b.name = c;
				b.params = [];e.replace(/[^,\s]+/g, function(a) {
					b.params.push(a)
				})
			}));return b
		}
		...
		CKEDITOR.plugins.link = {
			...
			parseLinkAttributes : function(c, b) {
				...
				if (!g.type)
					if (e = a.match(x)) g.type = "anchor", g.anchor = {}, g.anchor.name = g.anchor.id = e[1];
						...
						g.type = "email";
						var k = g.email = {};
						k.address = e[1];d && (k.subject = decodeURIComponent(d[1]));a && (k.body = decodeURIComponent(a[1]))
			...
			getLinkAttributes : function(c,
				...
				case "url":
					...
					break;case "anchor":
					a = b.anchor && b.anchor.id;f["data-cke-saved-href"] = "#" + (b.anchor && b.anchor.name || a || "");
					break;case "email":
					var d = b.email,
						e = d.address;
					switch (a) {
					...
					case "encode":
						...
						g && d.push("subject\x3d" +
							g);k && d.push("body\x3d" + k);d = d.length ? "?" + d.join("\x26") : "";"encode" == a ? (a = [ "javascript:void(location.href\x3d'mailto:'+", q(e) ], d && a.push("+'", p(d), "'"), a.push(")")) : a = [ "mailto:", e, d ];
						break;default:
		...
		CKEDITOR.plugins.add("pastefromword", {
			...
			init : function(a) {
				...
				a.addCommand("pastefromword", {
					...
					exec : function(a) {
						var c = this;
						b = 1;a.once("beforePaste", g);a.getClipboardData({
	...
	CKEDITOR.UI_MENUBUTTON = "menubutton";CKEDITOR.plugins.add("scayt", {
		...
		onLoad : function(a) {
			CKEDITOR.plugins.scayt.onLoadTimestamp = (new Date).getTime();"moono-lisa" == (CKEDITOR.skinName || a.config.skin) && CKEDITOR.document.appendStyleSheet(this.path + "skins/" + CKEDITOR.skin.name + "/scayt.css")
		},
		init : function(a) {
			var c = this,
				d = CKEDITOR.plugins.scayt;
			this.bindEvents(a);this.parseConfig(a);this.addRule(a);CKEDITOR.dialog.add(this.dialogName, CKEDITOR.getUrl(this.path + "dialogs/options.js"));
			this.addMenuItems(a);
			var b = a.lang.scayt,
				e = CKEDITOR.env;
			a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
				...
				var h = a.scayt,
					k,
					e;
				h && (e = h.getSelectionNode()) && (k = c.menuGenerator(a, e), h.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" .")));return k
		...
		bindEvents : function(a) {
			...
			a.on("contentDom", g);a.on("beforeCommandExec", function(b) {
				...
				var e = a.scayt;
				e && setTimeout(function() {
					e.removeMarkupInSelectionNode(d);c.reloadMarkup(e)
				}, b || 0)
		...
		parseConfig : function(a) {
			...
			c.state.scayt[a.name] = a.config.scayt_autoStartup;"boolean" !== typeof a.config.grayt_autoStartup &&
			(a.config.grayt_autoStartup = !1);"boolean" !== typeof a.config.scayt_inlineModeImmediateMarkup && (a.config.scayt_inlineModeImmediateMarkup = !1);
			c.state.grayt[a.name] = a.config.grayt_autoStartup;a.config.scayt_contextCommands || (a.config.scayt_contextCommands = "ignore|ignoreall|add");a.config.scayt_contextMenuItemsOrder || (a.config.scayt_contextMenuItemsOrder = "suggest|moresuggest|control");a.config.scayt_sLang || (a.config.scayt_sLang = "en_US");
			...
			"string" != typeof a.config.scayt_serviceProtocol && (a.config.scayt_serviceProtocol = null);"string" != typeof a.config.scayt_serviceHost &&
			(a.config.scayt_serviceHost = null);"string" != typeof a.config.scayt_servicePort && (a.config.scayt_servicePort = null);"string" != typeof a.config.scayt_servicePath && (a.config.scayt_servicePath = null);a.config.scayt_moreSuggestions || (a.config.scayt_moreSuggestions = "on");"string" !== typeof a.config.scayt_customerId && (a.config.scayt_customerId = "1:WvF0D4-UtPqN1-43nkD4-NKvUm2-daQqk3-LmNiI-z7Ysb4-mwry24-T8YrS3-Q2tpq2");"string" !== typeof a.config.scayt_srcUrl && (c = document.location.protocol, c = -1 != c.search(/https?:/) ?
				c : "http:", a.config.scayt_srcUrl = c + "//svc.webspellchecker.net/spellcheck31/lf/scayt3/ckscayt/ckscayt.js");"boolean" !== typeof CKEDITOR.config.scayt_handleCheckDirty && (CKEDITOR.config.scayt_handleCheckDirty = !0);"boolean" !== typeof CKEDITOR.config.scayt_handleUndoRedo && (CKEDITOR.config.scayt_handleUndoRedo = !0);
			CKEDITOR.config.scayt_handleUndoRedo = CKEDITOR.plugins.undo ? CKEDITOR.config.scayt_handleUndoRedo : !1;"boolean" !== typeof a.config.scayt_multiLanguageMode && (a.config.scayt_multiLanguageMode = !1);"object" !==
		...
		menuGenerator : function(a, c) {
			...
			for (var l in b) h && -1 == CKEDITOR.tools.indexOf(f, l.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[l] = "undefined" != typeof b[l].state ? b[l].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof b[l].verification || b[l].verification(a) ||
				delete e[l]
				, a.addCommand(l, {
					exec : b[l].exec
				}), a.addMenuItem(l, {
		...
		createScayt : function(a) {
			...
			this.loadScaytLibrary(a, function(a) {
				...
				if (f) {
					...
					a.scayt = g;a.fire("scaytButtonState", a.readOnly ? CKEDITOR.TRISTATE_DISABLED : CKEDITOR.TRISTATE_ON)
				} else
		...
		CKEDITOR.plugins.add("stylescombo", {
			...
			init : function(c) {
				...
				c.on("stylesSet", function(b) {
					if (b = b.data.styles) {
						for (var a, h, d, e = 0, n = b.length; e < n; e++) (a = b[e], c.blockless && a.element in CKEDITOR.dtd.$block || "string" == typeof a.type && !CKEDITOR.style.customHandlers[a.type] || (h = a.name, a = new CKEDITOR.style(a), c.filter.customConfig && !c.filter.check(a))) || (a._name = h, a._.enterMode = l.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), f[h] = a, k.push(a), m.push(a));
						k.sort(function(a, b) {
					...
					onOpen : function() {
						...
						for (var h in f) {
							var d = f[h],
								e = d._.type;
							d.checkApplicable(b, c, c.activeFilter) ? a[e]++ : this.hideItem(h);d.checkActive(b, c) && this.mark(h)
						}
						a[CKEDITOR.STYLE_BLOCK] || this.hideGroup(g["panelTitle" + String(CKEDITOR.STYLE_BLOCK)]);a[CKEDITOR.STYLE_INLINE] || this.hideGroup(g["panelTitle" + String(CKEDITOR.STYLE_INLINE)]);a[CKEDITOR.STYLE_OBJECT] ||
	...
	CKEDITOR.dom.element.prototype.focusPrevious = function(k, h) {
				...
				a.addCommand("table", new CKEDITOR.dialogCommand("table", {
					...
					exec : function(b) {
						...
						if (a) {
							...
							b = b.createRange();b.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START);a.remove();b.select()
						}
					}
		...
		function q(e,
			...
			b = new CKEDITOR.dom.range(b);b["moveToElementEdit" + (d ? "End" : "Start")](e) || (b.selectNodeContents(e), b.collapse(d ? !1 : !0));b.select(!0)
		}
		function z(e, d, b) {
			e = e[d];
		...
		function w(e, d, b) {
			...
			var f;
			e = c[0];
			a = e.getAscendant("table");var g = CKEDITOR.tools.buildTableMap(a),
				h = g.length,
				k = g[0].length,
			...
			d = e.getDocument();var p = l,
				q = r = 0,
				u = !b && new CKEDITOR.dom.documentFragment(d),
				w = 0;
			for (d = 0; d < c.length; d++) {
				f = c[d];var m = f.getParent(),
					x = f.getFirst(),
					v = f.$.colSpan,
					y = f.$.rowSpan,
					m = m.$.rowIndex,
					...
					w = w + v * y,
					q = Math.max(q, A - n + v);
				r = Math.max(r, m - l + y);b || (v = f, (y = v.getBogus()) && y.remove(), v.trim(), f.getChildren().count() && (m == p || !x || x.isBlockBoundary && x.isBlockBoundary({
					br : 1
			...
			if (b) return r *
					q == w;
			u.moveChildren(e);e.appendBogus();
		...
		function A(e, d) {
			...
			if (1 < k) {
				...
				for (var k = Math.floor(k /
					...
					if (n = f[g], n.parentNode == a.$ && g > h) {
						c.insertBefore(new CKEDITOR.dom.element(n));break
					} else
						n = null;
				n || a.append(c)
			} else
			...
			c.appendBogus();
			b.$.rowSpan = l;
			c.$.rowSpan = k;1 == l && b.removeAttribute("rowSpan");1 == k && c.removeAttribute("rowSpan");return c
		}
		function B(e, d) {
			var b = t(e);
			if (1 < b.length) return !1;
			...
			if (1 < g) c = Math.ceil(g / 2), g = Math.floor(g / 2);else {
				for (var g = c = 1, h = [], k = 0; k < a.length; k++) {
					var l = a[k];
					h.push(l[f]);1 < l[f].rowSpan && (k += l[f].rowSpan - 1)
				}
				for (a = 0; a < h.length; a++) h[a].colSpan++
			}
			a = b.clone();a.insertAfter(b);a.appendBogus();
			b.$.colSpan = c;
			a.$.colSpan = g;1 == c && b.removeAttribute("colSpan");1 == g && a.removeAttribute("colSpan");return a
		}
		var C = /^(?:td|th)$/;
		CKEDITOR.plugins.tabletools = {
			...
			init : function(e) {
				...
				b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", d({
				...
				})));CKEDITOR.dialog.add("cellProperties", this.path + "dialogs/tableCell.js");b("rowDelete", d({
					requiredContent : "table",
					exec : function(a) {
						a = a.getSelection();q(u(a))
					}
				}));b("rowInsertBefore", d({
					requiredContent : "table",
					exec : function(a) {
					...
					exec : function(a) {
						...
						e = new CKEDITOR.dom.element(l[e] || (e ? l[e - 1] : a.$.parentNode));n.length == p && a.remove();e && q(e, !0)
					}
				}));b("columnInsertBefore", d({
					requiredContent : "table",
					exec : function(a) {
						a = a.getSelection();m(a, !0)
					}
				...
				b("cellHorizontalSplit", d({
					...
					requiredContent : "table",
					exec : function(a) {
						a = a.getSelection();y(a, !0)
					}
				}));b("cellInsertAfter", d({
					requiredContent : "table",
					exec : function(a) {
						a = a.getSelection();y(a)
					}
